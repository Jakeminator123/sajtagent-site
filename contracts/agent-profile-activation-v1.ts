...
export const AgentProfileActivationProjectionV1Schema = z
  .object({
    schemaVersion: z.literal(AGENT_PROFILE_ACTIVATION_CONTRACT_VERSION_V1),
    activated: z.literal(true),
    profileId: IdentifierV1Schema,
...
export type AgentProfileActivationProjectionV1 = z.infer<
  typeof AgentProfileActivationProjectionV1Schema
>

export const AgentProfileActivationConflictCodeV1Schema = z.enum([
  "active_profile_revision_conflict",
  "activation_idempotency_conflict",
])

export type AgentProfileActivationConflictCodeV1 = z.infer<
  typeof AgentProfileActivationConflictCodeV1Schema
>

export const AgentProfileActivationConflictResponseV1Schema = z
  .object({
    schemaVersion: z.literal(AGENT_PROFILE_ACTIVATION_CONTRACT_VERSION_V1),
    error: z
      .object({
        code: AgentProfileActivationConflictCodeV1Schema,
...
export type AgentProfileActivationConflictResponseV1 = z.infer<
  typeof AgentProfileActivationConflictResponseV1Schema
>
