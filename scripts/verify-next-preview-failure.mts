...
assert.deepEqual(nextBuildFailureResponse(new Error("unsupported_package")), { status: 400, body: { error: "unsupported_package" } })
assert.deepEqual(nextBuildFailureResponse(new Error("invalid_package")), { status: 400, body: { error: "invalid_package" } })
...
assert.deepEqual(nextPagesFailureResponse(new Error("unsupported_package")), { status: 400, body: { error: "unsupported_package" } })
